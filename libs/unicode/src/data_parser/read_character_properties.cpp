...
void add_unknown_character(std::map <codepoint, character_properties> & props)
{
	// finally add the dead character - used when a character does not exist in the unicode range
	std::map <codepoint, character_properties>::const_iterator iter_not_present = 
...
void read_character_properties (std::map <codepoint, character_properties> & props)
{
